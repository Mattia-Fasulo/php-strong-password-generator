...
<body>
    <div class="main">
        <div class="container d-flex flex-column align-items-center">
            ...
            <form>
                <div class="row mb-3">
                    <label for="passwordLenght" class="col-sm-6 col-form-label">Lunghezza Password</label>
                    <div class="col-sm-6">
                        <input name="passwordLenght" type="number" class="form-control" id="passwordLenght">
                    </div>
                </div>
